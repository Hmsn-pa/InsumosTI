...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (_ssoPage) { localStorage.removeItem('insumos_sso_page'); navTo(validPages.includes(_ssoPage) ? _ssoPage : 'dashboard'); }
  else navTo(validPages.includes(hashPage) ? hashPage : 'dashboard');
